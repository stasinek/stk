...
//---------------------------------------------------------------------------
#include "tsoft_file_lzst_header.h"
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
#ifdef  LZSSv4_HEAD
...
int8_t __stdcall ts::file_header::__lzstv4_header_coder::plain_price(const uint32_t axdata_uncoded_len)
{
...
int8_t __stdcall ts::file_header::__lzstv4_header_coder::plain_encode(void *a_code_ptr, const uint32_t axdata_uncoded_len)
{
// 00LLLLLL
// <<2
// LLLLLL00
...
int8_t __stdcall ts::file_header::__lzstv4_header_coder::plain_decode(uint32_t *a_data_uncoded_len, const void *a_code_ptr)
{
// if N_CODE detected
// LLLLLLXX
// >>2
...
int8_t __stdcall ts::file_header::__lzstv4_header_coder::pattern_price(const uint32_t axdata_uncoded_counte, const uint32_t axdata_uncoded_elsize)
{
...
int32_t __stdcall ts::file_header::__lzstv4_header_coder::check_pattern_match_cost(const uint32_t alen, const uint32_t apattern_counte, const uint32_t apattern_elsize)
{
                register uint32_t t;
...
int8_t __stdcall ts::file_header::__lzstv4_header_coder::pattern_encode(void *a_code_ptr, const uint32_t axdata_uncoded_counte, const uint32_t axdata_uncoded_elsize)
{
// L - LENGTH
// 00LLLLLL
// <<2
...
int8_t __stdcall ts::file_header::__lzstv4_header_coder::pattern_decode(uint32_t *a_data_uncoded_counte, uint32_t *a_data_uncoded_elsize, const void *a_code_ptr)
{
...
int8_t __stdcall ts::file_header::__lzstv4_header_coder::dup_price(const  uint32_t axdata_uncoded_len, const uint32_t axdata_uncoded_offset)
{
                register uint32_t l = axdata_uncoded_len;
...
int32_t __stdcall ts::file_header::__lzstv4_header_coder::check_dup_match_cost(const uint32_t aplain_len, const uint32_t adup_len, const uint32_t adup_offset)
{
//
// CALCULATE
//
...
int8_t __stdcall ts::file_header::__lzstv4_header_coder::dup_encode(void *a_code_ptr, const uint32_t axdata_uncoded_len, const uint32_t axdata_uncoded_offset)
{
// L - LENGTH
// 0000LLLL
// <<2
...
int8_t __stdcall ts::file_header::__lzstv4_header_coder::dup_decode(uint32_t *a_data_uncoded_len, uint32_t *a_data_uncoded_offset, const void *a_code_ptr)
{
