#############################################################################
# Makefile for building: stk
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  stk.pro
# Template: lib
# Command: C:\Qt\Qt5.5.1\5.5\msvc2010\bin\qmake.exe -spec win32-msvc2010 "CONFIG+=debug" -o Makefile stk.pro
#############################################################################
...
Makefile: stk.pro C:\Qt\Qt5.5.1\5.5\msvc2010\mkspecs\win32-msvc2010\qmake.conf C:\Qt\Qt5.5.1\5.5\msvc2010\mkspecs\features\spec_pre.prf \
		...
		stk.pro
	$(QMAKE) -spec win32-msvc2010 "CONFIG+=debug" -o Makefile stk.pro
...
clean: debug-clean release-clean  FORCE
	-$(DEL_FILE) stk_pch.pch
	-$(DEL_FILE) stk.exp
	-$(DEL_FILE) stk.ilk
	-$(DEL_FILE) stk.idb
distclean: debug-distclean release-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) stk.lib stk.pdb
