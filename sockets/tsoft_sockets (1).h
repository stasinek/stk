...
class http_answer {
public:
		int32_t access_control_allow_orgin_is;
...
//A Base64-encoded binary MD5 sum of the content of the response
		...
		int32_t content_disposition_is;
...
//The HTTP status of the response
		...
		int32_t strict_transport_security_is;
