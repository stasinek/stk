...
public:
    ...
    struct __pharser {
#endif
        STK_IMPEXP  __stdcall  __pharser(void);
        STK_IMPEXP  __stdcall ~__pharser(void);
        ...
        int32_t STK_IMPEXP  __stdcall find(const char *lpsrc, const char *lpparameter_min, const char *lpparameter_normal, const char *lpparameter_alternative, char *r_lpsuboption);
        void    STK_IMPEXP  __stdcall delete_found(char *lpdst);
#ifdef __cplusplus
private:
#endif
