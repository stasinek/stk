...
#define MAXIMUM_FREQENCY		(__int32)(0x08000000)  /* 8*chars encoded so max size 2^28=250MB updates TREE_SIZE when the ROOT_POS frequency comes to this value. */
#define ROOT_NODE				   (__int32)(TREE_SIZE-1)	  /* position of ROOT_POS */
#define TOPMOST_NODE				(__int32)(0x1FFFFFFF)
//---------------------------------------------------------------------------
