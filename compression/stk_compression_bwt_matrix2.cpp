...
__DEBUG_CALLED("")
		...
		matrix_dim = ablock;
        matrix_idx_ptr = (uint32_t*)stk::mem::alloc(matrix_dim*(sizeof(uint32_t)));
		matrix_ptr	   =		(char*)stk::mem::alloc(matrix_dim*2);
        groups_bgn[0]  = (uint32_t*)stk::mem::alloc(matrix_dim*(sizeof(uint32_t)/2));
        groups_bgn[1]  = (uint32_t*)stk::mem::alloc(matrix_dim*(sizeof(uint32_t)/2));
        groups_end[0]  = (uint32_t*)stk::mem::alloc(matrix_dim*(sizeof(uint32_t)/2));
        groups_end[1]  = (uint32_t*)stk::mem::alloc(matrix_dim*(sizeof(uint32_t)/2));
}
//---------------------------------------------------------------------------
