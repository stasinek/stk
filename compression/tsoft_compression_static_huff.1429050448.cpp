...
#define TOPMOST_NODE		(0x3FFFFFFF)
#define ROOT_NODE 			(TREE_SIZE-1)	  /* position of ROOT_POS */
#define MAXIMUM_FREQENCY 	(0x10000000)  /* 8*chars encoded so max size 2^28=250MB updates TREE_SIZE when the ROOT_POS frequency comes to this value. */
//---------------------------------------------------------------------------

ts::compression::__static_huff_class::__static_huff_class(void)
{
...
void __stdcall ts::compression::__static_huff_class::initialize(void)
{
...
void __stdcall ts::compression::__static_huff_class::update(const char axdata_uncoded)
{
//------------------------------
//
...
char __stdcall ts::compression::__static_huff_class::encode(char *a_code_ptr, const char a_code_ptr_bit, const char axdata_uncoded)
{
...
//----------------------												/*  determine position in tree bit by bit */
		code = (code<<1) | (current_node & 0x00000001);
		code_bits++;
...
char __stdcall ts::compression::__static_huff_class::decode(char *alpdata_uncoded, const char *a_code_ptr, const char a_code_ptr_bit)
{
...
void __stdcall ts::compression::__static_huff_class::reconstruct(void)
{
