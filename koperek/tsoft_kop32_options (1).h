...
//---------------------------------------------------------------------------
		public:
				//------------------------------------
				int32_t operation;
#define OPERATION_NULL		(int32_t)0x00000000L
#define OPERATION_COPY		(int32_t)0x00000001L
#define OPERATION_ENCODE	(int32_t)0x00000002L
#define OPERATION_DECODE	(int32_t)0x00000004L
#define OPERATION_MOVE		(int32_t)0x00000008L
#define OPERATION_REMOVE	(int32_t)0x00000010L
#define OPERATION_LIST		(int32_t)0x00000020L
#define OPERATION_CHECKSUM	(int32_t)0x00000080L
#define OPERATION_COMPARE	(int32_t)0x00000021L
#define OPERATION_SELECT	(int32_t)0x00000040L
#define OPERATION_SEEK 		(int32_t)0x00080000L
				//------------------------------------
				int32_t ask_at_break, ask_at_error;
				//------------------------------------
				// block size kB 1-65536(64MB)
				int32_t block_size;
				//flush buffer or not
				int16_t block_is_cached;
				// coder type
				int16_t coder;
				// dict size 256B-16MB(0x100-0x01000000)
				int32_t coder_LZS_dup_size;
				// checksum
				int32_t checksum;
#define CHECKSUM_SSC1024 	(int32_t)0x00001000L
				// interval for checksum
				int32_t checksum_interval;
				//------------------------------------
