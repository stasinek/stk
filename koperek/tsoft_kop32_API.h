...
extern __int32 __stdcall console_monitor_proc(ts::__kop32_class *akop);

extern __int32 __stdcall start_in_console_mode(const char *args);
extern __int32 __stdcall start(const char *args, const char* (__stdcall *a_kop32_event_handler)(ts::__kop32_class*,const char*,const char*,const char*));
//---------------------------------------------------------------------------
}}
//---------------------------------------------------------------------------
#endif
