...
//---------------------------------------------------------------------------
int __stdcall start_kop32_in_gui_mode(const char *args, const stk::__kop32_class_progress_controler::__callback_event_handler*, const stk::con::__print_handler*,stk::con::__getch_handler*);
