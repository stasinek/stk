...
public:
		...
		//------------------------------------
		ts::__kop32_class *__stdcall owner		(void);
		...
		//------------------------------------
		const char* (__stdcall *callback_event_handler)(__kop32_class*, const char *a_event, const char *a_code, const char *a_code_ex);
