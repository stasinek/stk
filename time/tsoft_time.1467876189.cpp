...
void __stdcall ts::time::wait_ms(const double milliseconds) // cross-platform sleep function
{
#ifdef __DEBUG_TIME__
__DEBUG_FUNC_CALLED("")
#endif
...
void __stdcall ts::time::wait_us(const double microseconds) // cross-platform sleep function
{
#ifdef __DEBUG_TIME__
__DEBUG_FUNC_CALLED("")
#endif
