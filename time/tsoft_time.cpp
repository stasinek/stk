...
void __stdcall ts::time::wait_ms(const uint64_t milliseconds) // cross-platform sleep function
{
#ifdef __DEBUG_TIME__
__DEBUG_FUNC_CALLED("")
#endif
...
void __stdcall ts::time::wait_us(const uint64_t microseconds) // cross-platform sleep function
{
#ifdef __DEBUG_TIME__
__DEBUG_FUNC_CALLED("")
#endif
