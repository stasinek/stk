...
//------------------------------------
		int32_t  __stdcall  f_seek_src			(char *a_Source_ptr);
		int32_t  __stdcall  f_seek_src_file  	(char *a_Source_ptr, int32_t a_Base_path_len);
		ts::__database  *external_src_output_list_ptr, *external_mask_list_ptr;
		__open_file_struct  f_src_file;
//------------------------------------
		int32_t  __stdcall  f_seek_dst			 (char *a_Destination_ptr, char *a_Extension_to_add_ptr, char *a_Extension_to_delete_ptr);
...
//------------------------------------
	int32_t	__stdcall execute(char* a_Source_ptr, ts::__database* a_Mask_ptr, ts::__database* a_Destination_ptr);
	int32_t __stdcall create_destination_list(char*, char *a_Extension_to_add_ptr, char *a_Extension_to_delete_ptr, __database* a_Destination_ptr);
//------------------------------------
