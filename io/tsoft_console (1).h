...
extern void             __cdecl         printr  (const char* __restrict__ atext, int8_t an_times);
...
extern void             __stdcall       set_console_handlers(char (__stdcall *a_getch_event_handler)(void),void (__stdcall *a_print_event_handler)(const char*),void (__stdcall *a_error_event_handler)(const char*),void (__stdcall *a_debug_event_handler)(const char*));
