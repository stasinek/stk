...
char (__stdcall *ts::console::getch_handler)() = &ts::console::classic_getch_handler;
//(vcbprintf_callback_t callback, void **param, const char *format, va_list arglist);

//---------------------------------------------------------------------------

void __stdcall ts::console::set_console_handlers(char (__stdcall *agetcheventhandler)(void),void (__stdcall *aprinteventhandler)(char*))
{
...
char  __stdcall ts::console::classic_getch_handler(void)
{
	return getchar();
}
//---------------------------------------------------------------------------
