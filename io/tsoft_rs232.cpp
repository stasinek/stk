...
int32_t ts::com::open(const int8_t com_num, const int32_t baud, const char parity, const char data_bits, const char stop_bits)
{
...
int32_t ts::com::close(const int8_t com_num)
{
#ifdef __DEBUG_RS232__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t ts::com::send(const int8_t com_num,void *data,const int32_t len)
{
#ifdef __DEBUG_RS232__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t ts::com::recv(int8_t com_num,void *data,int32_t len)
{
#ifdef __DEBUG_RS232__
__DEBUG_FUNC_CALLED("")
#endif
