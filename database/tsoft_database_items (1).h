...
#define ATOM_TEXT_SIZE 255
                class __atom {
                        public:
                          char *text;
                        uint32_t text_size;
                        uint32_t number[ATOM_NUMBERS_COUNT]; void *data_chunk[ATOM_NUMBERS_COUNT];
        ...
        __stdcall       __database_items                (void);
                //------------------------------------
                inline const uint32_t __stdcall   count() const {
                return f_atom_matrix_count;
                }
                //------------------------------------
                const uint32_t          __stdcall       set_count                               (const uint32_t a_count);
                //------------------------------------
                ...
                //---------------------------------------------------------------------------
                inline const uint32_t __stdcall get_text_size(const uint32_t a_index_G) const {
                ...
                //---------------------------------------------------------------------------
                inline const uint32_t __stdcall get_number(const uint32_t a_index_G, const uint32_t a_column_Y) const {
                ...
                //------------------------------------
                const uint32_t                __stdcall       add                                             (const __atom * __restrict__ a_whole_atom);
                const uint32_t                __stdcall       add_text                                (const char* __restrict__ a_text);
                const uint32_t                __stdcall       add_data_chunk                  (const uint32_t a_column_Y, void *a_pointer);
                const uint32_t                __stdcall       add_number                              (const uint32_t a_column_Y, const uint32_t a_value);
                const uint32_t                __stdcall       insert                                  (const uint32_t a_index_I, const __atom *a_whole_atom);
                const uint32_t                __stdcall       insert_text                             (const uint32_t a_index_I, const char* __restrict__ a_text);
                const uint32_t                __stdcall       insert_number                   (const uint32_t a_index_I, const uint32_t a_column_Y, const uint32_t a_value);
                const uint32_t                __stdcall       insert_data_chunk               (const uint32_t a_index_I, const uint32_t a_column_Y, void *a_pointer);
                const uint32_t                __stdcall       cut                                             (const uint32_t a_index_C);
                const int32_t                 __stdcall       search_ex                               (const uint32_t a_index_S, const __atom * __restrict__ a_whole_atom) const;
                const int32_t                 __stdcall       search                                  (const __atom * __restrict__ a_whole_atom) const;
            //---------------------------------------------------------------------------
                const int32_t                 __stdcall       search_text_ex                  (const uint32_t a_index_S, const char* __restrict__ a_char) const;
            inline const int32_t      __stdcall   search_text             (const char* __restrict__ a_Char) const {
            return search_text_ex(0,a_Char);
            }
            //---------------------------------------------------------------------------
            const int32_t                             __stdcall       search_number_ex                (const uint32_t a_index_S, const uint32_t a_column_Y, const uint32_t a_number_value) const;
            inline const int32_t      __stdcall   search_number           (const uint32_t a_column_Y, uint32_t a_number) const {
            return search_number_ex(0,a_column_Y,a_number);
            }
            //---------------------------------------------------------------------------
            const int32_t                             __stdcall       search_data_chunk_ex    (const uint32_t a_index_S, const uint32_t a_column_Y, const void *a_pointer) const;
            inline const int32_t      __stdcall   search_data_chunk       (const uint32_t a_column_Y, const void *a_pointer) const {
