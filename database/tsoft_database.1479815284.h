//---------------------------------------------------------------------------
#ifndef tsoft_database_h
#define tsoft_database_h
#pragma once
//---------------------------------------------------------------------------
...
class __numbers {
                                ...
                                void   __stdcall operator= (int32_t i);
                                __stdcall operator int32_t () { return f_numbers; }
                                __stdcall ~__numbers() { }
} numbers[8];
...
class __text {
                                private:
                                __items *Owner;
                                char *f_text; int32_t f_text_size;
                                public:
