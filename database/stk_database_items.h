//---------------------------------------------------------------------------
#ifndef stk_database_items_h
#define stk_database_items_h
#pragma once
//---------------------------------------------------------------------------
#include "./../stk_main.h"
...
public:
	...
	//------------------------------------
    inline const stk::__database_items::__atom* __stdcall operator [] (const uint32_t a_index) const {
		return f_atom_matrix[a_index];
	}
	inline const stk::__database_items::__atom* __stdcall operator [] (const uint32_t a_index) {
		return f_atom_matrix[a_index];
	}
	//---------------------------------------------------------------------------
	inline const stk::__database_items::__atom* __stdcall get(const uint32_t a_index_G) const {
