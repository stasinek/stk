...
{
		return (char*)ts::mem32::alloc(alen);
}
//---------------------------------------------------------------------------
...
{
		return (char*)ts::mem32::realloc(alpdst, alen);
}
//---------------------------------------------------------------------------
...
char *__stdcall ts::cstr::mov_end(char *alpdst,const char *alpsrc,__int32 alen)
{
...
char *__stdcall ts::cstr::insert(char *alpdst, __int32 astart, const char *ainsert)
{
...
char *__stdcall ts::cstr::cut(char *alpdst, __int32 astart, __int32 alen)
{
...
char *__stdcall ts::cstr::cut_end(char *alpdst, __int32 astart, __int32 aend)
{
...
char *__stdcall ts::cstr::substr(char *alpdst, const char *alpsrc,__int32 astart, __int32 alen)
{
...
__int32 __stdcall ts::cstr::delimiter(const char *alpsrc, char adelimiter, __int32 adirection)
{
		if (adirection < 0) {
...
char *__stdcall ts::cstr::replace(char *alpdst, const char *alpfnd, const char *alpexh)
{
		for (__int32 pos = 0, find, lenco = ts::cstr::len(alpfnd), lennaco = ts::cstr::len(alpexh), lencel = ts::cstr::len(alpdst); pos < lencel; pos = find+lennaco) {
				if ((find=ts::cstr::pos(alpdst, pos, alpfnd))==-1)
						break;
				ts::cstr::cut(alpdst, find, lenco);
				ts::cstr::insert(alpdst, find, alpexh);
		}
		return alpdst;
}
//---------------------------------------------------------------------------
...
char *__stdcall ts::cstr::extract_fileroot(char *alpdst, const char *alpsrc)
{
		__int32 delimiter = ts::cstr::delimiter(alpsrc,'\\',+1);
		if (delimiter>=0) {
...
char *__stdcall ts::cstr::extract_file_path(char *alpdst, const char *alpsrc)
{
		__int32 delimiter = ts::cstr::delimiter(alpsrc,'\\',-1);
		if (delimiter>=0) {
				ts::cstr::substr_end(alpdst,alpsrc,0,delimiter);
...
char *__stdcall ts::cstr::extract_file_name(char *alpdst, const char *alpsrc)
{
		__int32 delimiter = ts::cstr::delimiter(alpsrc, '\\',-1);
		if (delimiter>=0) {
...
char *__stdcall ts::cstr::extract_file_ext(char *alpdst, const char *alpsrc)
{
		__int32 delimiter = ts::cstr::delimiter(alpsrc, '.',-1);
		if (delimiter>=0) {
				return ts::cstr::substr_end(alpdst,alpsrc,delimiter+1, len(alpsrc));
...
char *__stdcall ts::cstr::fix_file_path(char *alpdst, const char *alpsrc)
{
...
char *__stdcall ts::cstr::upr(char *alpdst)
{
...
char *__stdcall ts::cstr::lwr(char *alpdst)
{
		register __int32 l = len(alpdst);
		register __int32 i;
		for (i=0; i<l; i++) {
