...
//---------------------------------------------------------------------------
				extern const char	*__stdcall ltoa(const int32_t aint, char* astr, const int8_t abase);
				extern const char	*__stdcall ltoa(const int32_t aint, const int8_t abase);
				extern const char	*__stdcall ltoa(const int32_t aint);
				extern int32_t  __stdcall atol(const char *astr);
//---------------------------------------------------------------------------
}}}
//---------------------------------------------------------------------------
#endif // TSOFT_TEXT_H
