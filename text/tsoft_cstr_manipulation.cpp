...
char     *__stdcall ts::cstr::alloc(__int32 a_size) {
return (char*)ts::mem32::alloc(a_size); }
//---------------------------------------------------------------------------

char     *__stdcall ts::cstr::allocex(__int32 a_size, const char *a_src_ptr) {
return mov((char*)alloc(a_size), a_src_ptr); }
//---------------------------------------------------------------------------

char     *__stdcall ts::cstr::realloc(char *a_dst_ptr, __int32 a_size) {
return (char*)ts::mem32::realloc(a_dst_ptr, a_size); }
//---------------------------------------------------------------------------

char     *__stdcall ts::cstr::reallocex(char *a_dst_ptr, __int32 a_size, const char *a_src_ptr) {
return mov(realloc(a_dst_ptr,a_size),a_src_ptr); }
//---------------------------------------------------------------------------

void      __stdcall ts::cstr::free(char *a_dst_ptr) {
ts::mem32::free(a_dst_ptr);}
//---------------------------------------------------------------------------
...
#endif
    register __int32 sl = ts::cstr::len(a_src_ptr);
...
__DEBUG_FUNC_CALLED__
#endif
    register __int32 dl = ts::cstr::len(a_dst_ptr);
    register __int32 sl = ts::cstr::len(a_src_ptr);
...
char *__stdcall ts::cstr::mov_max(char *a_dst_ptr,const char *a_src_ptr,const __int32 a_len)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    register __int32 n = a_len;
    register char *ptr_s = (char*)a_src_ptr;
    register char *ptr_d = (char*)a_dst_ptr;
    for (;;ptr_s++,ptr_d++,n--) {
          if (n==0)
...
char* __stdcall ts::cstr::movi(char* a_dst_ptr, const char* a_src_ptr, const char c)
{
...
char* __stdcall ts::cstr::movi_dups(char* dst, const char* src)
{
...
char *__stdcall ts::cstr::insert(char *a_dst_ptr, __int32 astart, const char *ainsert)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    register __int32 insertlen = ts::cstr::len(ainsert), cellen = ts::cstr::len(a_dst_ptr);
...
char *__stdcall ts::cstr::cut(char *a_dst_ptr, __int32 astart, __int32 a_len)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    register __int32 len = ts::cstr::len(a_dst_ptr);
    register __int32 len_mov = len-astart-a_len;
...
char *__stdcall ts::cstr::cut_end(char *a_dst_ptr, __int32 astart, __int32 aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    ...
    register __int32 len = ts::cstr::len(a_dst_ptr);
    register __int32 len_mov = len-(aend+1);
...
__int32 __stdcall ts::cstr::pos(const char *a_src_ptr, const __int32 a_start, const char *a_seach_ptr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    register __int32 src_size = ts::cstr::len(a_src_ptr), fnd_size = ts::cstr::len(a_seach_ptr);
    return ts::mem32::pos(a_src_ptr, src_size, a_start, a_seach_ptr, fnd_size);
}
//---------------------------------------------------------------------------

__int32 __stdcall ts::cstr::pos_end(const char *a_src_ptr, const __int32 a_start, const char *a_seach_ptr, const __int32 aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
...
__int32 __stdcall ts::cstr::posr(const char *a_src_ptr, const __int32 a_start, const char *a_seach_ptr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    __int32 src_size = ts::cstr::len(a_src_ptr), fnd_size = ts::cstr::len(a_seach_ptr);
    return ts::mem32::posr(a_src_ptr, src_size, a_start, a_seach_ptr, fnd_size);
}
//---------------------------------------------------------------------------

/*__int32 __stdcall ts::cstr::posr_end(const char *a_src_ptr, const __int32 a_start, const char *a_seach_ptr, const __int32 aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
...
//---------------------------------------------------------------------------
*/
char *__stdcall ts::cstr::substr(char *a_dst_ptr, const char *a_src_ptr,__int32 astart, __int32 a_len)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
...
char *__stdcall ts::cstr::substr_end(char *a_dst_ptr, const char *a_src_ptr, __int32 astart, __int32 aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    ts::cstr::mov_max(a_dst_ptr,(char*)(&a_src_ptr[astart]),aend-astart);
    a_dst_ptr[aend-astart] = '\0';
    return a_dst_ptr;
}
//---------------------------------------------------------------------------

__int32 __stdcall ts::cstr::chr_end(const char *a_src_ptr, const char achr, const __int32 a_end)
{
    return ts::mem32::chr(a_src_ptr,achr,a_end + 1);
}
//---------------------------------------------------------------------------

__int32 __stdcall ts::cstr::chr(const char *a_src_ptr, const char achr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    register char  c = achr;
...
__int32 __stdcall ts::cstr::chrr(const char *a_src_ptr, const char a_chr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
...
__int32 __stdcall ts::cstr::chr_sum(const char* a_src_ptr, char a_chr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
...
__int32 __stdcall ts::cstr::len(const char *a_src_ptr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
...
char *__stdcall ts::cstr::brks(const char *a_src_ptr, const __int32 a_start, const char *a_brk)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    ...
    register __int32 pos;
    register __int32 brk_pos;
    register __int32 brk_len = ts::cstr::len(a_brk);
...
__int32 __stdcall ts::cstr::between(char* dst, const char* src, char c)
{
    return ts::cstr::between(dst,src,c,c);
}
//---------------------------------------------------------------------------

__int32 __stdcall ts::cstr::between(char* dst, const char* src, const char l, const char r)
{
...
if (src[0]=='\0')
return -1;
register __int32 L_pos = chr(src,l) + 1;
if (L_pos<=0) return -1;
register __int32 R_pos = L_pos + ts::cstr::chrr(src+L_pos, r) - 1;
if (R_pos< 0) return -1;
register __int32 len = R_pos -L_pos + 1;
...
__int32 __stdcall ts::cstr::between_words(char* dst, const char* src, const char *l, const char *r)
{
#ifdef __DEBUG_MEM32__
__DEBUG_FUNC_CALLED__
#endif
register __int32 src_len = ts::cstr::len(src);
register __int32 L_len = ts::cstr::len(l), R_len = ts::cstr::len(r);
if (R_len + L_len > src_len)
return -1;

register __int32 L_pos = ts::cstr::pos(src,0,l) + L_len;
if (L_pos< L_len) return -1;
register __int32 R_pos = ts::cstr::posr(src,L_pos,r);
if (R_pos< L_pos) return -1;
register __int32 len = R_pos - L_pos;
...
__DEBUG_FUNC_CALLED__
#endif
    for (register __int32 pos = 0, find, len_co = ts::cstr::len(a_seach_ptr), len_naco = ts::cstr::len(a_exch_ptr), lencel = ts::cstr::len(a_dst_ptr);; pos = find + len_naco) {
        if (a_dst_ptr[pos]=='\0')
            break;
...
char *__stdcall ts::cstr::replace_chr(char *a_dst_ptr, char a_seach_chr, char a_exch_chr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    for (register __int32 pos = 0;; pos++) {
...
register __int32 len = ts::cstr::len(a_ptr);
if (len==0)
return a_ptr;
register __int32 c1 = 0;
while (a_ptr[c1]==' ' && c1 < len) {
    c1++;
}
register __int32 c2 = len - 1;
while (a_ptr[c2]==' ' && c2 > 0) {
    c2--;
}
register __int32 len_mov = c2 - c1 + 1;
...
char *__stdcall ts::cstr::extract_file_root(char *a_dst_ptr, const char *a_src_ptr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    __int32 delimiter = ts::cstr::chr(a_src_ptr,'\\');
    if (delimiter>=0) {
...
char *__stdcall ts::cstr::extract_file_path(char *a_dst_ptr, const char *a_src_ptr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    __int32 delimiter = ts::cstr::chrr(a_src_ptr,'\\');
    if (delimiter>=0) {
        ts::cstr::substr_end(a_dst_ptr,a_src_ptr,0,delimiter);
        return a_dst_ptr;
    } else if (a_dst_ptr!=a_src_ptr) {
...
char *__stdcall ts::cstr::extract_file_name(char *a_dst_ptr, const char *a_src_ptr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
...
bool __stdcall ts::cstr::luhna_check(char *digits)
{
#ifdef __DEBUG_MEM32__
__DEBUG_FUNC_CALLED__
#endif
    register bool alt = false;
    register __int32 len = ts::cstr::len(digits);
    register __int32 sum = 0;
    for(register __int32 i = len - 1; i >= 0; i--)
    {
      int temp = digits[i];
      if(alt) {
         temp *= 2;
...
__int32  __stdcall ts::cstr::compare(const char *alp1, const char *alp2)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
...
__int32  __stdcall ts::cstr::compare_end(const char *alp1, const char *alp2, const __int32 aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
...
const char *__stdcall ts::cstr::itoa(const __int32 aint)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    return ts::cstr::itoa(aint,10);
}
//---------------------------------------------------------------------------

const char *__stdcall ts::cstr::itoa(const __int32 aint, const __int8 abase)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    static char str[32];
    return ts::cstr::itoa(aint,str,abase);
}
//---------------------------------------------------------------------------

const char *__stdcall ts::cstr::itoa(const __int32 aint, char* astr, const __int8 abase)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
    ...
    register __int32 r_int = aint;
    register __int32 i = 0;
    ...
    while (r_int != 0) {
        register __int32 rem = r_int % abase;
...
char *__stdcall ts::cstr::set(char *alpdst, const char a_znak_byte, const __int32 astart, const __int32 alen)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
ts::mem32::set((char*)alpdst+astart,a_znak_byte,alen);
return alpdst;
}
//---------------------------------------------------------------------------

char *__stdcall ts::cstr::set_end(char *alpdst, const char a_znak_byte, const __int32 astart, const __int32 aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED__
#endif
ts::mem32::set((char*)alpdst+astart,a_znak_byte,aend-astart);
return alpdst;
}
//---------------------------------------------------------------------------
