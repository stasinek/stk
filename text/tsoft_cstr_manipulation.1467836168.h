...
//---------------------------------------------------------------------------
        ...
        extern int32_t   __stdcall between_c            (char* dst, const char* src, const char  c);
        extern int32_t   __stdcall between_cc           (char* dst, const char* src, const char  l, const char  r);
...
//---------------------------------------------------------------------------
        ...
        //extern uint32_t	 __stdcall chrr_end				(const char *a_src_ptr, const char a_chr);
