...
inline const char      *__stdcall   set(const int32_t a_i_to_clone) {
...
inline int32_t          __stdcall   i(void) const {
...
inline                  __stdcall   operator int32_t () const {
return i();
}
...
inline const char*		__stdcall	operator= (const int32_t a_i_to_clone) {
