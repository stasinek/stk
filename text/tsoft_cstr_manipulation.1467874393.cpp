...
char     *__stdcall ts::cstr::alloc(int32_t a_size) {
return (char*)ts::mem32::alloc(a_size); }
//---------------------------------------------------------------------------

char     *__stdcall ts::cstr::allocex(int32_t a_size, const char *a_src_ptr) {
return mov((char*)alloc(a_size), a_src_ptr); }
//---------------------------------------------------------------------------

char     *__stdcall ts::cstr::realloc(char *a_dst_ptr, int32_t a_size) {
return (char*)ts::mem32::realloc(a_dst_ptr, a_size); }
//---------------------------------------------------------------------------

char     *__stdcall ts::cstr::reallocex(char *a_dst_ptr, int32_t a_size, const char *a_src_ptr) {
...
__DEBUG_FUNC_CALLED("")
#endif
    register int32_t sl = ts::cstr::len(a_src_ptr);
...
__DEBUG_FUNC_CALLED("")
#endif
    register int32_t dl = ts::cstr::len(a_dst_ptr);
    register int32_t sl = ts::cstr::len(a_src_ptr);
...
__DEBUG_FUNC_CALLED("")
#endif
    register int32_t l = ts::cstr::len(a_dst_ptr);
...
char *__stdcall ts::cstr::mov_max(char *a_dst_ptr,const char *a_src_ptr,const int32_t a_len)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
    register int32_t n = a_len;
    register char *ptr_s = (char*)a_src_ptr;
    register char *ptr_d = (char*)a_dst_ptr;
    for (;;ptr_s++,ptr_d++,n--) {
          if (n==0)
...
char *__stdcall ts::cstr::insert(char *a_dst_ptr, int32_t astart, const char *ainsert)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
    register int32_t insertlen = ts::cstr::len(ainsert), cellen = ts::cstr::len(a_dst_ptr);
...
char *__stdcall ts::cstr::cut(char *a_dst_ptr, int32_t astart, int32_t a_len)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
    register int32_t len = ts::cstr::len(a_dst_ptr);
    register int32_t len_mov = len-astart-a_len;
...
char *__stdcall ts::cstr::cut_end(char *a_dst_ptr, int32_t astart, int32_t aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
    ...
    register int32_t len = ts::cstr::len(a_dst_ptr);
    register int32_t len_mov = len-(aend+1);
...
int32_t __stdcall ts::cstr::pos(const char *a_src_ptr, const int32_t a_start, const char *a_seach_ptr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::cstr::pos_end(const char *a_src_ptr, const int32_t a_start, const char *a_seach_ptr, const int32_t aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::cstr::posr(const char *a_src_ptr, const int32_t a_start, const char *a_seach_ptr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
    int32_t src_size = ts::cstr::len(a_src_ptr), fnd_size = ts::cstr::len(a_seach_ptr);
    return ts::mem32::posr(a_src_ptr, src_size, a_start, a_seach_ptr, fnd_size);
}
//---------------------------------------------------------------------------

/*int32_t __stdcall ts::cstr::posr_end(const char *a_src_ptr, const int32_t a_start, const char *a_seach_ptr, const int32_t aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
//---------------------------------------------------------------------------
*/
char *__stdcall ts::cstr::substr(char *a_dst_ptr, const char *a_src_ptr,int32_t astart, int32_t a_len)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
char *__stdcall ts::cstr::substr_end(char *a_dst_ptr, const char *a_src_ptr, int32_t astart, int32_t aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::cstr::chr_end(const char *a_src_ptr, const char achr, const int32_t a_end)
{
    return ts::mem32::chr(a_src_ptr,achr,a_end + 1);
}
//---------------------------------------------------------------------------

int32_t __stdcall ts::cstr::chr(const char *a_src_ptr, const char achr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::cstr::chrr(const char *a_src_ptr, const char a_chr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::cstr::chr_sum(const char* a_src_ptr, char a_chr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::cstr::len(const char *a_src_ptr)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
char *__stdcall ts::cstr::brks(const char *a_src_ptr, const int32_t a_start, const char *a_brk)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
    ...
    register int32_t brk_pos;
    register int32_t brk_len = ts::cstr::len(a_brk);
...
int32_t __stdcall ts::cstr::between_c(char* dst, const char* src, char c)
{
    return ts::cstr::between_cc(dst,src,c,c);
}
//---------------------------------------------------------------------------

int32_t __stdcall ts::cstr::between_cc(char* dst, const char* src, const char l, const char r)
{
...
if (src[0]=='\0')
return -1;
register int32_t L_pos = chr(src,l) + 1;
if (L_pos<=0) return -1;
register int32_t R_pos = L_pos + ts::cstr::chrr(src+L_pos, r) - 1;
if (R_pos< 0) return -1;
register int32_t len = R_pos -L_pos + 1;
...
int32_t __stdcall ts::cstr::between_words(char* dst, const char* src, const char *l, const char *r)
{
#ifdef __DEBUG_MEM32__
__DEBUG_FUNC_CALLED("")
#endif
register int32_t src_len = ts::cstr::len(src);
register int32_t L_len = ts::cstr::len(l), R_len = ts::cstr::len(r);
if (R_len + L_len > src_len)
return -1;

register int32_t L_pos = ts::cstr::pos(src,0,l) + L_len;
if (L_pos< L_len) return -1;
register int32_t R_pos = ts::cstr::posr(src,L_pos,r);
if (R_pos< L_pos) return -1;
register int32_t len = R_pos - L_pos;
...
__DEBUG_FUNC_CALLED("")
#endif
    for (register int32_t pos = 0, find, len_co = ts::cstr::len(a_seach_ptr), len_naco = ts::cstr::len(a_exch_ptr), lencel = ts::cstr::len(a_dst_ptr);; pos = find + len_naco) {
        if (a_dst_ptr[pos]=='\0')
            break;
...
__DEBUG_FUNC_CALLED("")
#endif
    for (register int32_t pos = 0;; pos++) {
...
register int32_t len = ts::cstr::len(a_ptr);
if (len==0)
return a_ptr;
register int32_t c1 = 0;
while (a_ptr[c1]==' ' && c1 < len) {
    c1++;
}
register int32_t c2 = len - 1;
while (a_ptr[c2]==' ' && c2 > 0) {
    c2--;
}
register int32_t len_mov = c2 - c1 + 1;
...
__DEBUG_FUNC_CALLED("")
#endif
    int32_t delimiter = ts::cstr::chr(a_src_ptr,'\\');
    if (delimiter>=0) {
...
__DEBUG_FUNC_CALLED("")
#endif
    int32_t delimiter = ts::cstr::chrr(a_src_ptr,'\\');
    if (delimiter>=0) {
        ts::cstr::substr_end(a_dst_ptr,a_src_ptr,0,delimiter);
        return a_dst_ptr;
    } else if (a_dst_ptr!=a_src_ptr) {
...
__DEBUG_FUNC_CALLED("")
#endif
    register int32_t                              lensrc = ts::cstr::len(a_src_ptr);
    register int32_t lendestination = lensrc;
    if (lensrc==0) {
        a_dst_ptr[0]='\0';
        return a_dst_ptr;
    }
...
__DEBUG_FUNC_CALLED("")
    ...
    register int32_t len = ts::cstr::len(digits);
    register int32_t sum = 0;
    for(register int32_t i = len - 1; i >= 0; i--)
    {
      int temp = digits[i];
      if(alt) {
         temp *= 2;
...
int32_t  __stdcall ts::cstr::compare(const char *alp1, const char *alp2)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif

    register int32_t l1 = ts::cstr::len(alp1), l2 = ts::cstr::len(alp2),  r;
    if (l1>l2) {
...
int32_t  __stdcall ts::cstr::compare_end(const char *alp1, const char *alp2, const int32_t aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
const char *__stdcall ts::cstr::itoa(const int32_t aint)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
const char *__stdcall ts::cstr::itoa(const int32_t aint, const int8_t abase)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
const char *__stdcall ts::cstr::itoa(const int32_t aint, char* astr, const int8_t abase)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
    ...
    while (r_int != 0) {
        register int32_t rem = r_int % abase;
...
int32_t __stdcall ts::cstr::atoi(const char *asrc)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
char *__stdcall ts::cstr::set(char *alpdst, const char a_znak_byte, const int32_t astart, const int32_t alen)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
...
char *__stdcall ts::cstr::set_end(char *alpdst, const char a_znak_byte, const int32_t astart, const int32_t aend)
{
#ifdef __DEBUG_CSTR__
__DEBUG_FUNC_CALLED("")
#endif
