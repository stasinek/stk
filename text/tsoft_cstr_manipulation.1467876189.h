...
//---------------------------------------------------------------------------
        ...
        extern char     *__stdcall allocex              (size_t a_size, const char *a_src_ptr);
//---------------------------------------------------------------------------
        extern char     *__stdcall realloc              (char *a_dst_ptr, size_t a_size);
        extern char     *__stdcall reallocex            (char *a_dst_ptr, size_t a_size, const char *a_src_ptr);
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
        ...
        extern intmax_t	 __stdcall compare_end			(const char *alp1, const char *alp2, const size_t a_end);
...
//---------------------------------------------------------------------------
        extern char		*__stdcall set					(char *a_dst_ptr, const char a_znak_B, const size_t a_start, const size_t a_count);
        extern char		*__stdcall set_end				(char *a_dst_ptr, const char a_znak_B, const size_t a_start, const size_t a_end);
        ...
        //extern intmax_t	 __stdcall chrr_end				(const char *a_src_ptr, const char a_chr);
        ...
        inline size_t   __stdcall spn                  (const char *s, const char *set) {
...
//---------------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------------
        extern intmax_t		 __stdcall atoi             (const char *a_src_ptr);
        extern const char	*__stdcall itoa             (const intmax_t a_int, char* a_dst_ptr, const int8_t abase);
        extern const char	*__stdcall itoa             (const intmax_t a_int, const int8_t abase);
        extern const char	*__stdcall itoa             (const intmax_t a_int);
//---------------------------------------------------------------------------
