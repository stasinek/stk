...
#include <windows.h>
#pragma hdrstop
#include "DLLTSoft_FileRam.h"
#pragma link "DLLTSoft_DlaChara.obj"
//---------------------------------------------------------------------------
//DATABASE
//---------------------------------------------------------------------------

__stdcall TSoft_FileRam::TSoft_FileRam(void)
{
...
__stdcall TSoft_FileRam::TSoft_FileRam(char *AName)
{
...
void __stdcall TSoft_FileRam::SetName(char *AName)
{
maciez.FName = strReDup(maciez.FName,AName);
}
//---------------------------------------------------------------------------

bool __stdcall TSoft_FileRam::Open()
{
...
maciez.FHMap = CreateFileMapping(maciez.FHand,NULL,
                                 ...
                                 0,maciez.FRealSize, "TSoft_FileMem");
...
void __stdcall TSoft_FileRam::Close()
{
if (this->Base!=NULL)
...
long __stdcall TSoft_FileRam::Resize(long ASize)
{
...
void *__stdcall TSoft_FileRam::Alloc(long Aptr_size)
{
...
void *__stdcall TSoft_FileRam::ReAlloc(void *ptr, long Aptr_size)
{
__node *bgn = (__node*)this->Base;
...
void __stdcall TSoft_FileRam::Free(void *ptr)
{
__node *bgn = (__node*)this->Base;
__node *cur = (__node*)((ULONG)ptr - sizeof(__node));
__node *dad = (__node*)((ULONG)bgn + cur->prev);
...
void __stdcall TSoft_FileRam::Defrag()
{
__node *bgn = (__node*)this->Base;
...
void __stdcall TSoft_FileRam::Flush(void *ptr, long size)
{
