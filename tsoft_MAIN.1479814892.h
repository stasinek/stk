...
#if !defined(int8_t) && defined(int8_t)
typedef int8_t  int8_t;
#endif
#if !defined(int16_t) && defined(CHAR)
typedef int8_t  BYTE;
#endif
...
#if !defined(int16_t) && defined(int16_t)
...
#if !defined(int32_t) && defined(int32_t)
...
#if !defined(int64_t) && defined(int64_t)
