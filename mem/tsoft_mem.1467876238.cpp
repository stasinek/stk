...
__DEBUG_FUNC_CALLED("alloc(size_t)")
#endif
...
int32_t __stdcall ts::mem32::cmp(const void *a_ptr1, const void *a_ptr2, const size_t a_count)
{
#ifdef __DEBUG_MEM32__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::mem32::chr(const void *a_dst_ptr, const char a_znak_B, const size_t a_max_count)
{
#ifdef __DEBUG_MEM32__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::mem32::chrr(const void *a_dst_ptr, const char a_znak_B, const size_t a_max_count)
{
#ifdef __DEBUG_MEM32__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::mem32::pos(const void *a_src_ptr, const size_t a_src_size, const size_t a_start, const void *a_search_ptr, const size_t a_search_size)
{
#ifdef __DEBUG_MEM32__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::mem32::posr(const void *a_src_ptr, const size_t a_src_size, const size_t a_start, const void *a_search_ptr, const size_t a_search_size)
{
#ifdef __DEBUG_MEM32__
__DEBUG_FUNC_CALLED("")
#endif
...
int32_t __stdcall ts::mem32::pos_kmp(const void *a_src_ptr, const size_t a_src_size, const size_t a_start, const void *a_pattern_ptr, const size_t a_pattern_size)
{
    // Allocate variables
	int32_t *T;
	int32_t i, j;
	...
	// Lookup table
	T = (int32_t*)ts::mem32::alloc((strlen(r_pattern)+1) * sizeof(int32_t));
	T[0] = -1;
	for (i=0; r_pattern[i] != '\0'; i++) {
		T[i+1] = T[i] + 1;
		while (T[i+1] > 0 && r_pattern[i] != r_pattern[T[i+1]-1])
			T[i+1] = T[T[i+1]-1] + 1;
	}

	// Search
	for (i=j=0; r_text[i] != '\0'; ) {
