...
#define cbi(val,b) val = (val & ~(0x00000001<<b));
		inline unsigned __int8 bitcount(unsigned __int32 i)
		{
		...
		extern  void		 __stdcall bit_mov              (void *a_dst_ptr, const unsigned __int8 a_bit_dst, const void *a_src_ptr, const unsigned __int8 a_bit_src, const size_t a_bit_num);
		extern  void		 __stdcall bit_setex            (void *a_dst_ptr, const unsigned __int8 a_bit_dst, const void *a_src_ptr, const unsigned __int8 a_bit_src, const unsigned __int8 a_src_elelent_size, const size_t a_dst_count);
//---------------------------------------------------------------------------
}}
//---------------------------------------------------------------------------
