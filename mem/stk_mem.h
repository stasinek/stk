...
//---------------------------------------------------------------------------
		...
		extern "C" STK_IMPEXP void          *__stdcall swap                (void *a_ptr, const size_t a_head_count, const size_t a_tail_count);
		//---------------------------------------------------------------------------
		extern "C" STK_IMPEXP intmax_t       __stdcall cmp                 (const void *a_ptr1, const void *a_ptr2, const size_t a_count);
		//---------------------------------------------------------------------------
		extern "C" STK_IMPEXP void          *__stdcall set                 (void *a_dst_ptr, const unsigned char a_znak_B, const size_t a_count);
		extern "C" STK_IMPEXP void          *__stdcall setex               (void *a_dst_ptr, const void *a_src_ptr, const int8_t a_element_size, const size_t a_count);
		//---------------------------------------------------------------------------
		extern "C" STK_IMPEXP void          *__stdcall shr                 (void *a_dst_ptr, const size_t a_count);
		extern "C" STK_IMPEXP void          *__stdcall shl                 (void *a_dst_ptr, const size_t a_count);
		extern "C" STK_IMPEXP void          *__stdcall ror                 (void *a_dst_ptr, const size_t a_count);
		extern "C" STK_IMPEXP void          *__stdcall rol                 (void *a_dst_ptr, const size_t a_count);
		//---------------------------------------------------------------------------
		extern "C" STK_IMPEXP intmax_t       __stdcall chr                 (const void *a_src_ptr, const char a_znak_B, const size_t a_count);
		extern "C" STK_IMPEXP intmax_t       __stdcall chrr                (const void *a_src_ptr, const char a_znak_B, const size_t a_count);
//---------------------------------------------------------------------------
		extern "C" STK_IMPEXP intmax_t       __stdcall pos                 (const void *a_src_ptr, const size_t a_src_size, const size_t a_start, const void *a_pattern_ptr, const size_t a_pattern_size);
		extern "C" STK_IMPEXP intmax_t       __stdcall posr                (const void *a_src_ptr, const size_t a_src_size, const size_t a_start, const void *a_pattern_ptr, const size_t a_pattern_size);
		extern "C" STK_IMPEXP intmax_t       __stdcall pos_kmp	            (const void *a_src_ptr, const size_t a_src_size, const size_t a_start, const void *a_pattern_ptr, const size_t a_pattern_size);
