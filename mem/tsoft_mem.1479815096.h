...
//---------------------------------------------------------------------------
		extern  int32_t        __stdcall pos                  (const void *a_src_ptr, const size_t a_src_size, const size_t a_start, const void *a_search_ptr, const size_t a_search_size);
		extern  int32_t        __stdcall posr                 (const void *a_src_ptr, const size_t a_src_size, const size_t a_start, const void *a_search_ptr, const size_t a_search_size);
...
#define cbi(val,b) val = (val & ~(0x00000001<<b));
		inline unsigned int8_t bitcount(unsigned int32_t i)
		{
      	...
      	return (unsigned int8_t)i;
		}
		extern  void		 __stdcall bit_mov              (void *a_dst_ptr, const unsigned int8_t a_bit_dst, const void *a_src_ptr, const unsigned int8_t a_bit_src, const size_t a_bit_num);
		extern  void		 __stdcall bit_setex            (void *a_dst_ptr, const unsigned int8_t a_bit_dst, const void *a_src_ptr, const unsigned int8_t a_bit_src, const unsigned int8_t a_src_elelent_size, const size_t a_dst_count);
//---------------------------------------------------------------------------
}}
//---------------------------------------------------------------------------
