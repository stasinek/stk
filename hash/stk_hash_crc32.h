...
//---------------------------------------------------------------------------
extern STK_IMPEXP uint32_t   __stdcall calc_CRC32(const void *a_src_ptr, const uint32_t a_count);
extern STK_IMPEXP uint32_t   __stdcall calc_CRC32_next(const void *a_src_ptr, const uint32_t a_count,const uint32_t a_previous);
//extern STK_IMPEXP uint32_t   __stdcall calc_CRC32_bitwise(const void *a_src_ptr, const uint32_t a_count,const uint32_t a_previous);
