...
do{
stk::cstr::mov(t,"123456789");
if (calc_CRC32(t,stk::cstr::len(t))==0xCBF43926) {
stk::cstr::mov(t,"ZYXWVUTSRQPONMLKJIHGFEDBCA");
if (calc_CRC32(t,stk::cstr::len(t))==0x99cdfdb2) {
stk::cstr::mov(t,"The quick brown fox jumps over the lazy dog");
if (calc_CRC32(t,stk::cstr::len(t))==0x414fa339) {
continue;
}}}
} while (times++ < 1000000);
...
void __stdcall stk::hash::crc32::reset_CRC32(void)
{
#ifdef __DEBUG_HASH_CRC32__
__DEBUG_FUNC_CALLED("")
#endif
...
// for previous 0 -> init stays FFFFFFF, for real "previous" calculation it could be chunked etc.
 /*
#if ((__BORLANDC__ > 0x551) | defined(_MSC_VER)) & defined(__ASM_OPT__)
